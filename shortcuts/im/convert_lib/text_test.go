...
func TestRenderPostElem(t *testing.T) {
	tests := []struct {
		...
		{name: "mention user with id", el: map[string]interface{}{"tag": "at", "user_id": "@_user_1", "user_name": "Alice"}, want: `<at user_id="@_user_1">Alice</at>`},
		...
		{name: "md text", el: map[string]interface{}{"tag": "md", "text": "##### 标题\n\n<at user_id=\"ou_xxx\">刘佳澍</at> 你好"}, want: "##### 标题\n\n<at user_id=\"ou_xxx\">刘佳澍</at> 你好"},
...
func TestPostConverterConvertContentV2(t *testing.T) {
	...
	ctx2 := &ConvertContext{
		RawContent: `{"content":[[{"tag":"at","user_id":"@_user_1","user_name":"Bob"},{"tag":"text","text":" "},{"tag":"img","image_key":"img_123"}]]}`,
		Mentions:   []interface{}{map[string]interface{}{"key": "@_user_1", "id": "ou_bob", "name": "Bob"}},
	}
	want2 := `<at user_id="@_user_1">Bob</at> ![Image](img_123)`
